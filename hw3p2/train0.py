...
# #
import yaml
with open("config0.yaml") as file:
...
class Encoder(torch.nn.Module):
    ...
    def __init__(self, input_size, encoder_hidden_size):
        ...
        self.embedding = torch.nn.Sequential(
            ...
            torch.nn.ReLU(),
            torch.nn.Conv1d(encoder_hidden_size, encoder_hidden_size, kernel_size=3, padding=1),
            torch.nn.BatchNorm1d(encoder_hidden_size),
            torch.nn.ReLU(),
            torch.nn.Conv1d(encoder_hidden_size, encoder_hidden_size, kernel_size=3, padding=1),
            torch.nn.BatchNorm1d(encoder_hidden_size),
        ...
        self.BLSTMs = LSTMWrapper(
            # TODO: Look up the documentation. You might need to pass some additional parameters.
            torch.nn.LSTM(input_size=encoder_hidden_size, \
...
run_name = '{}_0326_scheduler'.format(config['Name'])
